...
# For sphinx sitemap
# base_url = 'http://upgrade-drf.com/docs/'
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.viewcode']  # 'sphinx_sitemap'
...
project = u'django-rest-framework-0.4'
...
html_title = "Django REST framework 0.4"
