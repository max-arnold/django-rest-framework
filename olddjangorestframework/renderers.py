...
from olddjangorestframework.compat import yaml
from olddjangorestframework.utils import dict2xml, url_resolves
from olddjangorestframework.utils.breadcrumbs import get_breadcrumbs
from olddjangorestframework.utils.mediatypes import get_media_type_params, add_media_type_param, media_type_matches
from olddjangorestframework import VERSION
...
class DocumentingHTMLRenderer(DocumentingTemplateRenderer):
    ...
    format = 'html'
    template = 'olddjangorestframework/api.html'
...
class DocumentingPlainTextRenderer(DocumentingTemplateRenderer):
    ...
    format = 'txt'
    template = 'olddjangorestframework/api.txt'
