...
from olddjangorestframework.authentication import UserLoggedInAuthentication
from olddjangorestframework.compat import RequestFactory, unittest
from olddjangorestframework.mixins import RequestMixin
from olddjangorestframework.parsers import FormParser, MultiPartParser, \
...
class TestContentParsingWithAuthentication(TestCase):
    urls = 'olddjangorestframework.tests.test_content'
