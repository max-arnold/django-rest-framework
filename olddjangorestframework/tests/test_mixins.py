...
from olddjangorestframework.mixins import CreateModelMixin, PaginatorMixin, ReadModelMixin
...
from olddjangorestframework.tests.models import CustomUser
from olddjangorestframework.tests.test_testcases import TestModelsTestCase
