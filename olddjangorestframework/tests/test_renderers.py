...
from olddjangorestframework.compat import View as DjangoView
from olddjangorestframework.renderers import BaseRenderer, JSONRenderer, YAMLRenderer, \
    XMLRenderer, JSONPRenderer, DocumentingHTMLRenderer
from olddjangorestframework.parsers import JSONParser, YAMLParser, XMLParser
...
urlpatterns = patterns('',
    ...
    url(r'^api', include('olddjangorestframework.urls', namespace='olddjangorestframework'))
)
...
class RendererIntegrationTests(TestCase):
    ...
    urls = 'olddjangorestframework.tests.test_renderers'
...
class JSONPRendererTests(TestCase):
    ...
    def test_without_callback_with_json_renderer(self):
        ...
        self.assertEquals(resp['Content-Type'], 'application/json-p; charset=utf-8')
