...
from olddjangorestframework.renderers import JSONRenderer
from olddjangorestframework.reverse import reverse, reverse_lazy
...
class ReverseTests(TestCase):
    ...
    """
    urls = 'olddjangorestframework.tests.test_reverse'
